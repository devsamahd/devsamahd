        ...
        <div className="row" data-aos="fade-in" id='about'>
          ...
          <div className="col-md-6">
            ...
            >
              ...
              I'm always motivated to build or lead people to come up with what users will love and will satisfy business requirements. I am dynamic in my operations and I'm always yearning to make an impact with every line of code. <br /> <br />
